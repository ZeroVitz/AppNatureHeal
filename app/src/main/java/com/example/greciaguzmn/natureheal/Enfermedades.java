...
public class Enfermedades extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Enfermedad, EnfermedadViewHolder> FirebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Enfermedad, EnfermedadViewHolder>(
           Enfermedad.class, R.layout.lista_view, EnfermedadViewHolder.class,mDatabase) {

            @Override
            protected void populateViewHolder(EnfermedadViewHolder viewHolder, Enfermedad model, final int position) {
