...
public class DetalleEnfermedad2 extends AppCompatActivity {
    ...
    private DatabaseReference dbMigraña = mRootRef.child("enfermedades").child("migraña");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTitulo = (TextView) findViewById(R.id.dtituloenfermedad2);
        txtDescripcion = (TextView) findViewById(R.id.parrafoMigraña);
        txtPrecaucion = (TextView) findViewById(R.id.parrafo1PreMigraña);
        txtRecomendacion = (TextView) findViewById(R.id.parrafoRecMigraña);
        txtSintomas = (TextView) findViewById(R.id.parrafoSintomasMigraña);
    }
    ...
    protected void onStart() {
        ...
        dbMigraña.addValueEventListener(new ValueEventListener() {
